...
export const getAllPurchaseBills = async (req: Request, res: Response) => {
  try {
...
export const getPurchaseBillById = async (req: Request<{ id: string }>, res: Response) => {
  try {
    const { id } = req.params;
...
export const createPurchaseBill = async (req: Request<{}, any, CreatePurchaseBillRequest>, res: Response) => {
  try {
...
export const deletePurchaseBill = async (req: Request<{ id: string }>, res: Response) => {
  try {
    const { id } = req.params;
